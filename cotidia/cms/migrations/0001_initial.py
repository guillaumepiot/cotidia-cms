    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(related_name='translations', to='cms.Page', on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='page',
            name='dataset',
            field=models.ForeignKey(blank=True, null=True, to='cms.PageDataSet', on_delete=models.SET_NULL),
        ),
        migrations.AddField(
            model_name='page',
            name='parent',
            field=mptt.fields.TreeForeignKey(blank=True, null=True, related_name='children', to='cms.Page', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='page',
            name='published_from',
            field=models.ForeignKey(blank=True, null=True, to='cms.Page', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='page',
            name='redirect_to',
            field=models.ForeignKey(blank=True, null=True, related_name='redirect_to_page', to='cms.Page', on_delete=models.SET_NULL),
        ),
        migrations.AddField(
            model_name='page',
            name='related_pages',

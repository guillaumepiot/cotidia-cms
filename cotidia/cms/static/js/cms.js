...
onLoad = function() {
  ...
  ContentTools.StylePalette.add([new ContentTools.Style('Header hero', 'head-text--hero', ['h1']), new ContentTools.Style('Header second level', 'head-text--second-level', ['h2']), new ContentTools.Style('Header third level', 'head-text--third-level', ['h3']), new ContentTools.Style('Article subheader', 'article-subheader', ['h2']), new ContentTools.Style('Image centered', 'image-center', ['img']), new ContentTools.Style('Text white', 'text-white', ['h1', 'h2', 'h3', 'h4', 'h5', 'p', 'a']), new ContentTools.Style('Text gray dark', 'text-gray-dark', ['h1', 'h2', 'h3', 'h4', 'h5', 'p', 'a']), new ContentTools.Style('Text gray medium', 'text-gray-medium', ['h1', 'h2', 'h3', 'h4', 'h5', 'p', 'a']), new ContentTools.Style('Text gray light', 'text-gray-light', ['h1', 'h2', 'h3', 'h4', 'h5', 'p', 'a']), new ContentTools.Style('Text blue', 'text-blue', ['h1', 'h2', 'h3', 'h4', 'h5', 'p', 'a']), new ContentTools.Style('Text blue dark', 'text-blue-dark', ['h1', 'h2', 'h3', 'h4', 'h5', 'p', 'a']), new ContentTools.Style('Text bold', 'text-bold', ['h1', 'h2', 'h3', 'h4', 'h5', 'p', 'a']), new ContentTools.Style('Text italic', 'text-italic', ['h1', 'h2', 'h3', 'h4', 'h5', 'p', 'a']), new ContentTools.Style('Blockquote', 'text-blockquote', ['h1', 'h2', 'h3', 'h4', 'h5', 'p', 'a']), new ContentTools.Style('Text size: hero', 'text-hero', ['h1', 'h2', 'h3', 'h4', 'h5', 'p', 'a']), new ContentTools.Style('Text size: large', 'text-large', ['h1', 'h2', 'h3', 'h4', 'h5', 'p', 'a']), new ContentTools.Style('Text size: medium', 'text-medium', ['h1', 'h2', 'h3', 'h4', 'h5', 'p', 'a']), new ContentTools.Style('Text size: emphasis', 'text-emphasis', ['h1', 'h2', 'h3', 'h4', 'h5', 'p', 'a']), new ContentTools.Style('Text size: normal', 'text-normal', ['h1', 'h2', 'h3', 'h4', 'h5', 'p', 'a']), new ContentTools.Style('Text size: micro', 'text-micro', ['h1', 'h2', 'h3', 'h4', 'h5', 'p', 'a']), new ContentTools.Style('Button white / blue', 'btn--white-blue', ['a']), new ContentTools.Style('Button white / red', 'btn--white-red', ['a']), new ContentTools.Style('Button black / blue', 'btn--black-blue', ['a'])]);
